...
if (isset($_GET['delete'])) {
    $id = (int)$_GET['delete'];
    $conn->query("DELETE FROM customer WHERE idpelanggan = $id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_edit'])) {
    ...
    $conn->query("UPDATE customer SET nama='$nama', alamat='$alamat', notelepon='$notelepon' WHERE idpelanggan=$id");
    header("Location: customer.php");
} elseif ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $notelepon = $_POST['notelepon'];
    $conn->query("INSERT INTO customer (nama, alamat, notelepon) VALUES ('$nama', '$alamat', '$notelepon')");
    header("Location: customer.php");
}
...
<html lang="en">
    <head>
        ...
        <title>Data Pelanggan</title><meta charset="UTF-8">
    ...
    <body class="sb-nav-fixed">
        <main>
            <div class="container-fluid px-4" style="margin-top: 80px">
                <h1 class="mt-4" style="margin-left: 250px; margin-top: 50px" >Pelanggan</h1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="?delete=<?= $row['idpelanggan'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus?')">Delete</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
